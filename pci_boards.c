    ...
    if (access->recover == 1) {
        for (dev = pacc->devices; dev != NULL; dev = dev->next) {
            ...
            if ((dev->vendor_id == VENDORID_XIO2001) && (dev->device_id == DEVICEID_XIO2001)) {
                ...
                strncpy(board->llio.board_name, "6I25 (RECOVER)", 15);
    ...
    for (dev = pacc->devices; dev != NULL; dev = dev->next) {
        ...
        if (dev->vendor_id == VENDORID_MESAPCI) {
            if (dev->device_id == DEVICEID_MESA4I74) {
                board->type = BOARD_PCI;
                strncpy((char *) board->llio.board_name, "4I74", 5);
                ...
                board->type = BOARD_PCI;
                strncpy((char *) board->llio.board_name, "5I24", 5);
                board->llio.num_ioport_connectors = 3;
                board->llio.pins_per_connector = 24;
                ...
                board->type = BOARD_PCI;
                strncpy((char *) board->llio.board_name, "5I25", 5);
                board->llio.num_ioport_connectors = 2;
                board->llio.pins_per_connector = 17;
                board->llio.ioport_connector_name[0] = "P3";
                board->llio.ioport_connector_name[1] = "P2";
                ...
                board->type = BOARD_PCI;
                strncpy((char *) board->llio.board_name, "6I24", 5);
                board->llio.num_ioport_connectors = 3;
                board->llio.pins_per_connector = 24;
                board->llio.ioport_connector_name[0] = "P4";
                board->llio.ioport_connector_name[1] = "P3";
                ...
                board->type = BOARD_PCI;
                strncpy(board->llio.board_name, "6I25", 5);
                board->llio.num_ioport_connectors = 2;
                board->llio.pins_per_connector = 17;
                board->llio.ioport_connector_name[0] = "P3";
                board->llio.ioport_connector_name[1] = "P2";
            ...
            if (dev->device_id == DEVICEID_PLX9030) {
                ...
                if (ssid == SUBDEVICEID_MESA5I20) {
                    board->type = BOARD_PCI;
                    strncpy(board->llio.board_name, "5I20", 5);
                    board->llio.num_ioport_connectors = 3;
                    board->llio.pins_per_connector = 24;
...
// fix up LASxBRD READY if needed
                    ...
                    board->type = BOARD_PCI;
                    strncpy(board->llio.board_name, "4I65", 5);
                    board->llio.num_ioport_connectors = 3;
                    board->llio.pins_per_connector = 24;
                    board->llio.ioport_connector_name[0] = "P1";
                    board->llio.ioport_connector_name[1] = "P3";
...
// fix up LASxBRD READY if needed
                ...
                if ((ssid == SUBDEVICEID_MESA4I68_OLD) || (ssid == SUBDEVICEID_MESA4I68)) {
                    board->type = BOARD_PCI;
                    strncpy(board->llio.board_name, "4I68", 5);
                    board->llio.num_ioport_connectors = 3;
                    board->llio.pins_per_connector = 24;
                    board->llio.ioport_connector_name[0] = "P1";
                    board->llio.ioport_connector_name[1] = "P2";
                    ...
                    board->type = BOARD_PCI;
                    strncpy(board->llio.board_name, "5I21", 5);
                    board->llio.num_ioport_connectors = 2;
                    ...
                    board->type = BOARD_PCI;
                    strncpy(board->llio.board_name, "5I22", 5);
                    ...
                    board->type = BOARD_PCI;
                    strncpy(board->llio.board_name, "5I23", 5);
                    board->llio.num_ioport_connectors = 3;
                    board->llio.pins_per_connector = 24;
                    board->llio.ioport_connector_name[0] = "P2";
                    board->llio.ioport_connector_name[1] = "P3";
                    ...
                    board->type = BOARD_PCI;
                    strncpy(board->llio.board_name, "4I69", 5);
                    board->llio.num_ioport_connectors = 3;
                    board->llio.pins_per_connector = 24;
                    board->llio.ioport_connector_name[0] = "P1";
                    board->llio.ioport_connector_name[1] = "P3";
                ...
                if ((ssid == SUBDEVICEID_MESA3X20_10) || (ssid == SUBDEVICEID_MESA3X20_15) || (ssid == SUBDEVICEID_MESA3X20_20)) {
                    board->type = BOARD_PCI;
                    strncpy(board->llio.board_name, "3X20", 5);
                    ...
                    board->type = BOARD_PCI;
                    strncpy(board->llio.board_name, "5I71", 5);
                    board->open = &pci_board_open;
                    board->close = &pci_board_close;
                    board->print_info = &pci_print_info;
                    board->dev = dev;
